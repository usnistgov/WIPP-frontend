...
import { CsvCollectionDetailComponent, CsvCollectionListComponent, 
          ...
          GenericDataCollectionDetailComponent, GenericDataCollectionListComponent, 
...
const appRoutes: Routes = [
    ...
    { path: 'generic-data-collections', component: GenericDataCollectionListComponent },
    { path: 'generic-data-collections/:id', component: GenericDataCollectionDetailComponent },
